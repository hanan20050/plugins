...
# Place Diamond Block + Beacon right under player's feet and print location
cmds = [
    "execute at @a run setblock ~ ~-1 ~ minecraft:diamond_block",
    "execute at @a run setblock ~ ~ ~ minecraft:beacon",
    "execute as @a run tellraw @s [{\"text\":\"[System] Marked your current location as Center!\",\"color\":\"gold\"}]"
]
