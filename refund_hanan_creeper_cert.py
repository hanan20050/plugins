...
BACKUP_FILE = "backup_hanan_creeper_refund.json"
...
def execute_refund():
    ...
    print(f"🔍 Attempting to clear 1 written book (Certificate) from {player_name} inventory...")
    ...
    backup_data = {
        ...
        "flag_removed": "other-explosion"
    }
    with open(BACKUP_FILE, "w") as f:
        json.dump(backup_data, f, indent=2)

    # 1. Unset other-explosion flag & wg save
    send_command(f"rg flag -w \"world\" {player_name} other-explosion")
    ...
    send_command(f"msg {player_name} §6[Refund Complete] §aCertificate returned! §eYour Creeper protection upgrade was returned and 32 Emeralds refunded to your inventory.")

    print(f"\n🎉 Successfully processed 32 Emerald refund for {player_name}!")
...
def undo():
    ...
    send_command("msg hanansaleh §6[Undo] §eRollback completed. 32 Emeralds cleared and Creeper flag restored.")
