...
min_x, max_x = 1193, 1211
min_z, max_z = -381, -363

cmds = [
    # 1. Clear area with air up to Y=90
    f"fill {min_x} {cy} {min_z} {max_x} {cy+27} {max_z} air",
    # 2. Kill dropped item loot using vanilla namespace
    f"minecraft:kill @e[type=item,x={cx},y={cy+10},z={cz},distance=..35]"
]
