...
# Place door directly in the entrance gap on the south wall (Z = -367)
cmds = [
    f"setblock {cx} {cy+1} {hz_max} birch_door[half=lower,hinge=left,facing=south]",
    f"setblock {cx} {cy+2} {hz_max} birch_door[half=upper,hinge=left,facing=south]"
]
