...
cmds = [
    # 1. Fill base floor at Y=63 with grass_block across exact 30x30 area
    f"fill {min_x} {cy} {min_z} {max_x} {cy} {max_z} minecraft:grass_block",
    # Also fill at player location at current Y level
    f"execute at @a run fill ~-14 63 ~-14 ~15 63 ~15 minecraft:grass_block",
    # Clear any dropped item loot
